...
int main(void) {
  ...
  double entr_mode_min = 1.0E-2;
  double entr_mode_max = 1.0E2;
  double prss_mode_min = pow(10.0, 18.4581859998271);
  double prss_mode_max = pow(10.0, 37.84367789977789);
